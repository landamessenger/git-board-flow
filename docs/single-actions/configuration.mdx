...
description: Inputs for running single actions in Git Board Flow
---
...
For `check_progress_action`, `detect_errors_action`, `recommend_steps_action`, and `deployed_action`:
