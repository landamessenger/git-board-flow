...
<Card title="How many boards do you want to work with?" icon="table-columns">
  ...
  Define the links to all the boards where you want to track the issue. Linking the issue to a board requires a Personal Access Token (PAT).
    ...
    git-board-issues:
      ...
      steps:
        ...
        - name: Git Board - Issue
          ...
          with:
            github-token-personal: ${{ secrets.REPO_PAT }}
            project-urls: https://github.com/orgs/landamessenger/projects/1, https://github.com/orgs/landamessenger/projects/2
  ```
</Card>
