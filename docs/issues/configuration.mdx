...
- `opencode-model`: Model in provider/model format (default: "opencode/kimi-k2.5")
...
- `ai-members-only`: Restrict AI features to organization/project members (default: "true")
