...
1. A hotfix branch is created from `main-branch` at the latest tag version
...
7. The issue is automatically closed with the `deployed-label` label once the process completes
