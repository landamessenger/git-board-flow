...
- `priority-high-label`: Priority high label (default: "priority: high")
- `priority-medium-label`: Priority medium label (default: "priority: medium")
- `priority-low-label`: Priority low label (default: "priority: low")
- `priority-none-label`: Priority none label (default: "priority: none")
