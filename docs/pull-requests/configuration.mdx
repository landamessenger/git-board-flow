...
See [AI PR description](/pull-requests/ai-description) for how the description is generated and [OpenCode (AI)](/opencode-integration) for server and model setup.
