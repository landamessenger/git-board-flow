...
export declare class FileRepository {
    ...
    getChunkedRepositoryContent: (owner: string, repository: string, branch: string, chunkSize: number, token: string, ignoreFiles: string[], progress: (fileName: string) => void, ignoredFiles: (fileName: string) => void) => Promise<ChunkedFile[]>;
